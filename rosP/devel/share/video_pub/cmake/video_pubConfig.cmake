...
if("TRUE" STREQUAL "TRUE")
  set(video_pub_SOURCE_PREFIX /home/chris/rosP/src/video_pub)
  set(video_pub_DEVEL_PREFIX /home/chris/rosP/devel)
  ...
  set(video_pub_INSTALL_PREFIX /home/chris/rosP/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'video_pub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chris/rosP/src/video_pub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chris/rosP/devel/lib;/home/chris/rosP/devel/lib;/home/chris/rader_station2022/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND video_pub_EXPORTED_TARGETS ${${video_pub_dep}_EXPORTED_TARGETS})
endforeach()
